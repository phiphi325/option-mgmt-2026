...
| | |
|---|---|
| **ID** | `seed_skill_hyperframes` |
| **Description** | HyperFrames video generation platform |
| **Tags** | — |
| **When to use** | When authoring or debugging HyperFrames video compositions, loading skills, working with media sync, timeline architecture, and web-to-video transformation |
