...
| | |
|---|---|
| **ID** | `seed_skill_hyperframes_cli` |
| **Description** | HyperFrames CLI tool usage and configuration |
| **Tags** | — |
| **When to use** | When scaffolding a project, linting, validating, inspecting visual layout in compositions, previewing in the studio, rendering to video, transcribing audio, generating TTS, or troubleshooting the HyperFrames environment |
